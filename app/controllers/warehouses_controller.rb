class WarehousesController < ApplicationController
  ...
  def create
    wh_code = SecureRandom.urlsafe_base64(4,16)
    @warehouse = Warehouse.new(warehouse_params.merge(wh_code: wh_code))


    respond_to do |format|
      if @warehouse.save
        @warehouse.products.update_all(threshold: 10,count: 0)
  ...
  private
    ...
    def warehouse_params
      params.require(:warehouse).permit(:wh_code, :name, :pincoode, :max_capacity,:product_ids)
    end
end
